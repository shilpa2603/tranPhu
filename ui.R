...
shinyUI(
  fluidPage(
    ...
    titlePanel(title ="Final Project Phuong Linh"),
    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               radioButtons(inputId ="continuous_variable", label = "Continuous", choices = c("ages", "hours_per_week"), selected = "histogram"),   # add radio buttons for continuous variables
